...
<div class="main-jsgl main-sc">
    <p class="attention"><span>注意:</span>后台增加了代理商功能，默认没有开启，代理商商城下单有优惠价，其他暂时无意义！</p>
    <div class="jsglNr">
            ...
            <div class="selectNr selectNr2">
                <div class="left">
                    <div class="seleK">
                        ...
                        <label>
                            <span>是否代理商:</span>
                            <select name="is_agent" class="select w100">
                                <option value="999">请选择</option>
                                <option <?php if(($is_agent) == "0"): ?>selected="selected"<?php endif; ?> value="0">否</option>
                                <option <?php if(($is_agent) == "1"): ?>selected="selected"<?php endif; ?> value="1">是</option>
                            </select>
                        </label>
                    </div>
                </div>
        ...
        <div class="tableBox">
            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                        ...
                        <td>
                        余额:<?php echo round($var['money']/100,2); if(($var["money_negative"]) > "0"): ?><br/>(可负:<?php echo round($var['money_negative']/100,2);?>)<?php endif; ?><br/>
                    ...
                    <td class="w150">
                        ...
                        <?php echo BA('user/money',array("user_id"=>$var["user_id"]),'余额','load','remberBtn_small',600,450);?>
                        ...
                        <?php if(($var["is_agent"]) == "0"): echo BA('user/agent',array("user_id"=>$var["user_id"]),'开通代理商','act','remberBtn_small');?>
                        <?php else: ?>
                          <?php echo BA('user/agent',array("user_id"=>$var["user_id"]),'取消代理商','act','remberBtn_small_quxiao'); endif; ?>          
