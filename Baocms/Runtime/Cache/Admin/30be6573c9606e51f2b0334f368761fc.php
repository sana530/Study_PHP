...
<div class="main-jsgl main-sc">
    ...
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            ...
            <div class="right">
                <form class="search_form" method="post" action="<?php echo U('booking/noaudit');?>">
        ...
        <form method="post" action="<?php echo U('booking/noaudit');?>">
    ...
    <form  target="baocms_frm" method="post">
        <div class="tableBox">
            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                    ...
                    <td>
                    <?php echo BA('booking/audit',array("shop_id"=>$var["shop_id"]),'审核','act','remberBtn');?>
                    <?php if($var["audit"] != 2): echo BA('ding/refuse',array("shop_id"=>$var["shop_id"]),'拒绝','load','remberBtn',400,250); endif; ?>
        ...
        <div class="selectNr" style="margin-bottom: 0px; border-bottom: none;">
            <div class="left">
                ...
                <?php echo BA('booking/audit','','批量审核','list',' remberBtn');?>
            </div>
        </div>
    </form>
</div>
