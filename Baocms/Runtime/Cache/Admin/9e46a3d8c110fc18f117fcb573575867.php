...
<div class="main-jsgl main-sc">
    ...
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            <div class="right">
                <form class="search_form" method="post" action="<?php echo U('order/wait');?>"> 
            ...
            <form  target="baocms_frm" method="post">
                ...
                <div class="selectNr" style="margin-bottom: 0px; border-bottom: none;">
                    <div class="left">
                        ...
                        <?php echo BA('order/pick','','加入捡货列表','list','remberBtn');?>
                        <?php echo BA('order/clean','','清空捡货队列','act','remberBtn');?>
