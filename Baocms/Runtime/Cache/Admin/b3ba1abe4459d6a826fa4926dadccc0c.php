    ...
    <div class="mainScAdd">
        <div class="tableBox">
            <table  bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;" >
                <tr>
                    ...
                    <td class="rgTdBt">
                        <select name="data[dxapi]"  class="scAddTextName sogn">
                            <option value="bu" <?php if($CONFIG['sms']['dxapi'] == bu): ?>selected='selected'<?php endif; ?>>Burst SMS</option>
                ...
                <tr>
                    <td class="rgTdBt profit" colspan="2"> Burst SMS Setting</td>
                </tr>
                <tr class="jq_type_dy">
                    <td class="lfTdBt">Burst SMS：</td>
                    <td class="rgTdBt">API Key: <input type="text" name="data[bukey]" value="<?php echo ($CONFIG["sms"]["bukey"]); ?>" class="scAddTextName " />
                        &nbsp;&nbsp;API Secret: <input type="text" name="data[busecret]" value="<?php echo ($CONFIG["sms"]["busecret"]); ?>" class="scAddTextName " />
                        <code>Burst SMS Setting</code></td>
                </tr>
                <tr>
                    <td class="rgTdBt profit" colspan="2"> 大于短信配置，注意，签名要跟站点名称一致</td>
                </tr>
                <tr class="jq_type_bo">
                    <td class="lfTdBt">大于短信签名：</td>
                    <td class="rgTdBt">
                        <input type="text" name="data[sign]" value="<?php echo ($CONFIG["sms"]["sign"]); ?>"  class="scAddTextName " />
                        <code>填写您在大于官方申请的短信签名，建议跟站点名称一致</code>
                    </td>
                </tr>
                <tr class="jq_type_dy">
                ...
                <tr>
                    <td class="rgTdBt profit" colspan="2"> 万能短信配置，注意，签名要跟站点名称一致</td>
                </tr>
                <tr class="jq_type_bo">
