        ...
        <div class="tableBox">
         ...
         <tr>
           ...
           <input type="text" name="data[tribe_id]" value='<?php echo ($CONFIG["site"]["tribe_id"]); ?>' class="scAddTextName " />
                ...
                <tr style="display: none;">
                    <td class="lfTdBt">1stPay扫一扫登陆密钥：</td>
                    <td class="rgTdBt"><input type="text" name="data[1stpay_scan_login]" value="<?php echo ($CONFIG["site"]["1stpay_scan_login"]); ?>" class="scAddTextName " />
                        <code>这里填写1stPay扫一扫登陆在本站的密钥,请不要乱修改</code>
                    </td>
                </tr>

                <tr>
                    <td class="lfTdBt">允许访问Admin的IP地址：</td>
                    <td class="rgTdBt"><input type="text" name="data[admin_allow_ip]" value="<?php echo ($CONFIG["site"]["admin_allow_ip"]); ?>" class="scAddTextName " />
                        <code>不要有空格，并请用"|"隔开。例如：192.168.1.1|192.168.1.2|192.168.1.3</code>
                    </td>
                </tr>
