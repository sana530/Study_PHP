...
<form  target="baocms_frm" action="<?php echo U('booking/create');?>" method="post">
    <div class="mainScAdd">
        <div class="tableBox">
            <table  bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;" >
                ...
                <tr>
                    ...
                    <td class="rgTdBt"><input id="price" type="text" name="data[price]" value="<?php echo (($detail["price"])?($detail["price"]):''); ?>" class="scAddTextName w210" />
                    ...
                    <td class="rgTdBt"><input id="mobile" type="text" name="data[mobile]" value="<?php echo (($detail["mobile"])?($detail["mobile"]):''); ?>" class="scAddTextName w210" />

                    </td>
                </tr><tr>
                    <td class="lfTdBt">商家电话：</td>
                    <td class="rgTdBt"><input id="tel" type="text" name="data[tel]" value="<?php echo (($detail["tel"])?($detail["tel"]):''); ?>" class="scAddTextName w210" />
