...
.comiis_19forum .comiis_19forum_icon{width:48px;height:48px;position:absolute;top:0;right:0px;background:url(../../attachs/comiis_ico.gif) no-repeat 0 top;border-radius:5px;}
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            <span class="comiis_19forum_icon"></span>
            <h2><a href="#">资金统计</a></h2>
            <em>会员总资金<?php echo round($counts['money_and']/100,2);?>NZD</em>
        </div>
            <div class="comiis_19forum_list">
            <h3><a href="<?php echo U('usermoneylogs/index');?>">1:会员总资金<?php echo round($counts['money_and']/100,2);?>NZD</a></h3>
            <h3><a href="<?php echo U('usermoneylogs/index');?>">2:会员总积分<?php echo ($counts['money_integral']); ?>分</a></h3>
            <h3><a href="<?php echo U('usercash/index');?>">3:今日提现<a class="red"><?php echo round($counts['money_cash_day']/100,2);?></a>NZD，<a class="red"><?php echo ($counts['money_cash_audit']); ?></a>人待审</a></h3>
            </div>
    </div>
</div>
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            ...
            <h3><a href="<?php echo U('usermoneylogs/index');?>">6:还有<a class="red"><?php echo round($counts['community_order']/100,2);?></a>NZD物业费未缴</a></h3>
            </div>
    </div>
</div>
</li>
