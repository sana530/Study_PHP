<?php if (!defined('THINK_PATH')) exit();?><title>配送记录</title>
<!DOCTYPE html>
<html lang="zh-cn">
	<head>
		<meta charset="utf-8">
...
<ul id="shangjia_tab">
        <li style="width: 50%;"><a href="<?php echo U('index/lists',array('id'=>$rdv['id']));?>" class="on">物流订单</a></li>
        <li style="width: 50%;"><a href="<?php echo U('index/expresslists',array('id'=>$rdv['id']));?>">快递订单</a></li>
</ul>
...
<div class="line tab-bar">
	<div class="button-toolbar">
		<div class="button-group">
			<a class="block button bg-dot active" href="#">物流订单列表，共(<?php echo ($count); ?>)条</a>
		</div>
	</div>
</div>
...
<?php if(is_array($list)): foreach($list as $key=>$var): ?><li class="line padding">
        <div class="x12">
            <p class="text-small">订单号:<?php echo ($var["order_id"]); ?> &nbsp;&nbsp;|&nbsp;&nbsp;类型：<?php if(($var["type"]) == "0"): ?>商城<?php endif; if(($var["type"]) == "1"): ?>外卖<?php endif; ?>&nbsp;&nbsp;|&nbsp;&nbsp; 订单编号：<?php echo ($var["type_order_id"]); ?>&nbsp;&nbsp;|&nbsp;&nbsp;状态：<?php if(($var["status"]) == "0"): ?><span style="color:#f6b300;">等待接单</span><?php endif; ?>
                            <?php if(($var["status"]) == "1"): ?><span style="color:#f6b300;">等待接单</span><?php endif; ?>
                            <?php if(($var["status"]) == "2"): ?><span style="color:#ff0000;">配送中</span><?php endif; ?>
                            <?php if(($var["status"]) == "8"): ?><span style="color:#18c900;">已完成</span><?php endif; ?> </p> 

            <p class="text-small">商店信息：<?php echo ($var["shop_name"]); ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo ($var["shop_addr"]); ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo ($var["shop_mobile"]); ?></p>
            <p class="text-small">购买人信息：<?php echo ($var["user_name"]); ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo ($var["user_addr"]); ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo ($var["user_mobile"]); ?></p>
