...
<!-- 筛选TAB -->
<ul id="shangjia_tab">
        <li class="x4"><a href="<?php echo LinkTo('coupon/index');?>" <?php if(($aready) == ""): ?>class="on"<?php endif; ?>>全部</a></li>
        <li class="x4"><a href="<?php echo LinkTo('coupon/index',array('aready'=>1));?>" <?php if(($aready) == "1"): ?>class="on"<?php endif; ?>>未使用</a></li>
        <li class="x4"><a href="<?php echo LinkTo('coupon/index',array('aready'=>2));?>" <?php if(($aready) == "2"): ?>class="on"<?php endif; ?>>已使用</a></li>
...
<script>
	$(document).ready(function () {
		loaddata('<?php echo U("coupon/couponloading",array("t"=>$nowtime,"p"=>"0000","aready"=>$aready));?>', $("#list-media ul"), true);
	});
</script>
