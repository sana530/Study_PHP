...
.member-top { margin-top: 0px;}
	...
	<header class="top-fixed bg-yellow bg-inverse transparent" id="header">
        ...
        <div class="top-search" style="display:none;">
			<form method="post" action="<?php echo U('mobile/all/index');?>">
...
<span><a href="<?php echo u('money/index');?>"><em><?php echo round($MEMBER['money']/100,2);?></em><p>余额</p></a> </span>


<?php if($MEMBER['money_negative'] > 0): ?><span onclick="javascript:layer.msg('您的扫街信用额度申请已通过，您当前余额透支额度为:<?php echo round($MEMBER['money_negative']/100,2);?>使用额度透支服务以后，请务必在48小时内还款，以免产生每周10$的手续费',{icon:1,area:'360px'});"><em><?php echo round($MEMBER['money_negative']/100,2);?></em><p>额度</p> </span>
<?php else: ?>
     <span><a href="<?php echo u('/mcenter/credit');?>"><em><?php echo round($MEMBER['money_negative']/100,2);?></em><p>额度</p></a> </span><?php endif; ?>
<span><a href="<?php echo u('mobile/jifen/index');?>"><em><?php echo ($MEMBER["integral"]); ?></em><p>积分</p></a> </span>
<span><a href="<?php echo u('mobile/favorites/index');?>"><i class="goods-browse"></i><p>足迹</p></a> </span>
</div> 
</div>
...
<li style="display:none;"><a href="<?php echo U('information/index');?>"><span class="icon-gears"></span>账户管理<i class="icon-angle-right"></i></a></li>
...
<?php if(!empty($user_delivery)): ?><li><a href="<?php echo U('delivery/index/index');?>"><span class="icon-bus"></span>配送员中心登录<font>（<?php echo ($user_delivery['first_name']); ?>）</font><i class="icon-angle-right"></i></a></li><?php endif; ?>

<li><a href="<?php echo u('money/index');?>"><span class="icon-money"></span>余额充值<i class="icon-angle-right"></i></a></li>
<li><a href="<?php echo u('money/transfer');?>"><span class="icon-usd"></span>转账给好友<i class="icon-angle-right"></i></a></li>
<li><a href="<?php echo u('money/collectioncode');?>"><span class="icon-qrcode"></span>收款二维码<i class="icon-angle-right"></i></a></li>
...
<li style="display:none;"><a href="<?php echo U('pinche/index');?>"><span class="icon-car"></span>我的拼车<i class="icon-angle-right"></i></a></li>
<li><a href="<?php echo U('hotel/index');?>"><span class="icon-hotel"></span>我的酒店<i class="icon-angle-right"></i></a></li>
<li style="display:none;"><a href="<?php echo U('farm/index');?>"><span class="icon-paw"></span>我的农家乐<i class="icon-angle-right"></i></a></li>
