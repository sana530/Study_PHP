...
<div class="content_right">
            ...
            <form action="<?php echo U('order/index');?>" method="post">
                <div class="search_form"> 
                    ...
                    <select name="st" class="search_form_zt">
                        ...
                        <option <?php if(($st) == "1"): ?>selected="selected"<?php endif; ?>  value="1">已付款</option>
                        <option <?php if(($st) == "-1"): ?>selected="selected"<?php endif; ?>  value="-1">到店付</option>
                        <option <?php if(($st) == "0"): ?>selected="selected"<?php endif; ?>  value="3">正在退款</option>
                        <option <?php if(($st) == "0"): ?>selected="selected"<?php endif; ?>  value="4">已退款</option>
                        <option <?php if(($st) == "-1"): ?>selected="selected"<?php endif; ?>  value="8">已完成</option>
                    </select>
  ...
  <tbody><tr class="tr_left_2">
    ...
    订单ID:<span class="mallorder_jg"><?php echo ($var["order_id"]); ?></span>
    <span class="td_top_1">交易时间:<?php echo (date('Y-m-d H:i:s',$var["create_time"])); ?>   </span></td>
  </tr>
  <tr>
    <td class="td_left_1"> 
    ...
    <table class="tuan_table2" width="100%" border="0">
      <tbody><tr class="tr_left_1">
        ...
        <a target="_blank" href="<?php echo U('pchome/tuan/detail',array('tuan_id'=>$var['tuan_id']));?>" class="index__pic___TScfk">
        
        <img src="<?php echo config_img($tuan[$var['tuan_id']]['photo']);?>"><span></span></a>
        <div class="index__infos___A6XLq">
            <p><a href="<?php echo U('pchome/tuan/detail',array('tuan_id'=>$var['tuan_id']));?>" target="_blank"><span></span><span><?php echo ($tuan[$var['tuan_id']]['title']); ?></span><span></span></a><span></span><span></span></p>
            <span></span>
            <p>有效期至:<?php echo ($tuan[$var['tuan_id']]['fail_date']); ?></p>
            </p>
            </if>
       ...
       <!--商品展示END-->
        ...
        <td class="left2"><?php echo ($var["num"]); ?></td>
        <td class="left3">&#36;<?php echo round($var['total_price']/100,2);?></td>
        <td class="left5"> </td>
      </tr>
    ...
    实际支付:&#36;<?php echo round($var['need_pay']/100,2);?><br/>
    <?php if($var['mobile_fan'] > 0): ?>手机立减:<span class="text-dot"><?php echo round($var['mobile_fan']/100,2);?>NZD<br/><?php endif; ?>
                        
    <?php if($var['use_integral'] > 0): ?>使用积分:<?php echo ($var["use_integral"]); ?> &nbsp;&nbsp;<br/>
    抵现:&#36; <?php echo round($var['use_integral']/100,2);?> NZD<?php endif; ?>
                           
             
     </td>
    <td class="left8" width="20%">
    
     <?php if($var['status'] == -1): ?><a class="">到店付</a>	
      <?php elseif($var['status'] == 0): ?>
        <a class="myInfor_sx myInfor_sx_fk" target="_blank" href="<?php echo U('pchome/tuan/pay',array('order_id'=>$var['order_id']));?>">去付款</a>
      <?php elseif($var['status'] == 1): ?>
      	<a class="">已付款</a>
      <?php elseif($var['status'] == 3): ?>
      	<a class="">正在退款</a>
      <?php elseif($var['status'] == 4): ?>
        <a class="">已退款</a>
      <?php elseif($var['status'] == 8): ?>
      	 <a class="">已完成</a><?php endif; ?>
     <br>
     <?php if($var['mobile_fan'] > 0): ?><img src="/themes/default/Shangjia/statics/images/mobile.png"><?php endif; ?>       

    </td>
    <td class="left9" width="15%">
    
      <?php if($var['status'] == -1): ?><a mini='confirm' href="<?php echo U('order/delete',array('order_id'=>$var['order_id']));?>">取消订单</a>
      <?php elseif($var['status'] == 0): ?>
        <a mini='confirm' href="<?php echo U('order/delete',array('order_id'=>$var['order_id']));?>">取消订单</a><?php endif; ?>

    <br> 
    <a href="<?php echo U('order/detail',array('order_id'=>$var['order_id']));?>">订单详情</a>
    </td>
  </tr>
