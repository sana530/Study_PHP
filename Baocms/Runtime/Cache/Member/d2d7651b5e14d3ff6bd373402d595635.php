    	...
    	<tbody><tr>
            <td colspan="4">
            	<div class="mallorder_tBox">
                    <span class="mallorder_t">订单编号:<span class="mallorder_jg"><?php echo ($detail["order_id"]); ?></span></span>
                    <span class="mallorder_t">订单金额:<span class="mallorder_jg">$ <?php echo round($detail['total_price']/100,2);?> NZD</span></span>
                    <span class="mallorder_t">配送费用:<span class="mallorder_jg">$ <?php echo round($detail['total_express']/100,2);?> NZD</span></span>
                 </div>
            </td>
        </tr>
       ...
       <tr style="background-color:#F9F9F9;">
     	...
     	<?php if(is_array($ordergoods)): foreach($ordergoods as $key=>$item): ?><tr>
            ...
            <td>
            	...
            	<div class="mallorder_xq"><img width="60" src="<?php echo config_img($goods[$item['goods_id']]['photo']);?>"><p><?php echo ($goods[$item['goods_id']]['title']); ?></p></div>
            </td>
            <td><span class="mallorder_jg">$<?php echo round($item['price']/100,2);?></span></td>
            <td><?php echo ($item["num"]); ?></td>
            <td><span class="mallorder_jg"><?php echo round($item['total_price']/100,2);?> NZD</span></td>
        ...
        <tr>
            <td colspan="4"><div class="con_ri">实际支付:<span class="mallorder_jg"> $ <?php echo round($detail['total_express']/100 + $detail['need_pay']/100 ,2);?></span></div></td>
        </tr>        
        <tr>
            <td colspan="4" style="background-color:;">
            	<div class="mallorder_tBox">
                	<p class="">收货姓名:<?php echo ($addr['name']); ?></p>
                    <p class="">手机号码:<?php echo ($addr["mobile"]); ?></p>
                    <p class="">配送地址:<?php echo ($citys[$addr['city_id']]['name']); ?> <?php echo ($areas[$addr['area_id']]['area_name']); ?> <?php echo ($bizs[$addr['business_id']]['business_name']); ?> <?php echo ($addr["addr"]); ?></p>
                    <p class="">用户留言:<?php echo ($detail["message"]); ?></p>
                </div>
            </td>
        </tr>        
                 <tr>
            <td colspan="4" style="background-color:;">
            	<div class="mallorder_tBox">
                <?php if(($detail["is_daofu"]) == "0"): if(($detail["status"]) == "0"): ?><p class=""><a class="myInfor_sx myInfor_sx_fk" href="<?php echo U('mobile/mall/pay',array('order_id'=>$detail['order_id']));?>">去付款</a></p>
                    <?php else: ?>
                    	<p class=""><a class="myInfor_sx myInfor_sx_fk"><?php echo ($types[$detail['status']]); ?></a></p><?php endif; ?>
                   		 <?php else: ?>
                    <?php if(($detail["status"]) == "0"): ?><p class=""><a class="myInfor_sx myInfor_sx_fk"> 货到付款</a></p>
                    	<?php else: ?>
                    	<p class=""><a class="myInfor_sx myInfor_sx_fk"><?php echo ($types[$detail['status']]); ?></a></p><?php endif; endif; ?>
                </div>
            </td>
        </tr>
