...
<div class="content_right">  
    ...
    <ul>
        <li <?php if($act == 'base'): ?>class="on"<?php endif; ?>><a href="<?php echo U('set/base');?>">基本设置</a></li>
        <li <?php if($act == 'nickname'): ?>class="on"<?php endif; ?>><a href="<?php echo U('set/nickname');?>">昵称设置</a></li>
        <li <?php if($act == 'face'): ?>class="on"<?php endif; ?>><a href="<?php echo U('set/face');?>">修改头像</a></li>
        <li <?php if($act == 'password'): ?>class="on"<?php endif; ?>><a href="<?php echo U('set/password');?>">修改密码</a></li>
        <li <?php if($act == 'mobile'): ?>class="on"<?php endif; ?>><a href="<?php echo U('set/mobile');?>">手机认证</a></li>
        <li <?php if($act == 'email'): ?>class="on"<?php endif; ?>><a href="<?php echo U('set/email');?>">邮箱认证</a></li>
        <li <?php if($act == 'paypass'): ?>class="on"<?php endif; ?>><a href="<?php echo U('set/paypass');?>">修改支付密码</a></li>
    </ul>
</div>
        <form method="post"  action="<?php echo U('set/base');?>"  target="baocms_frm">
            <div class="password_nr">
                <div class="password_input">
                    <div class="left">职业</div>
                    <div class="lef int_box"><input class="oldPassw" name="job" type="text" value="<?php echo ($usersex["job"]); ?>" /></div>
                </div>
                <div class="password_input">
                    <div class="left">性别</div>
                    <div class="lef sex"><input class="radio" name="sex" type="radio" <?php if($usersex['sex'] == 1): ?>checked="checked"<?php endif; ?> value="1" />男&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="radio" name="sex" type="radio" <?php if($usersex['sex'] == 2): ?>checked="checked"<?php endif; ?> value="2" />女</div>
                </div>
                <div class="password_input">
                    <div class="left">出生日期</div>
                    <div class="lef select_box">
                        <select class="sel_year" name="born_year" rel="<?php echo (($usersex["born_year"])?($usersex["born_year"]):'2000'); ?>"></select>年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <select class="sel_month" name="born_month" rel="<?php echo (($usersex["born_month"])?($usersex["born_month"]):'2'); ?>"></select>月&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <select class="sel_day" name="born_day" rel="<?php echo (($usersex["born_day"])?($usersex["born_day"]):'15'); ?>"></select>日&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                </div>
                <div class="password_input">
                    ...
                    <div class="lef select_box">
                        <select name="star_id">
                            <?php $i = 1; ?>
                            <?php if(is_array($stars)): foreach($stars as $key=>$item): ?><option value="<?php echo ($i); ?>" <?php if(($usersex["star_id"]) == $i): ?>selected="selected"<?php endif; ?> ><?php echo ($item); ?></option>
