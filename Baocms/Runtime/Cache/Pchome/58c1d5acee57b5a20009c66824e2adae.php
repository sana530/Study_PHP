                ...
                <div class="order-box">
                    <table class="order" width="100%">
                        ...
                        <?php if(is_array($cart_goods)): foreach($cart_goods as $key=>$item): ?><tr>
                                <td>
                                    <div class="tab_nr">
                                        <div class="left tab_img"><a target="_blank" href="<?php echo U('mall/detail',array('goods_id'=>$item['goods_id']));?>"><img src="<?php echo config_img($item['photo']);?>" width="134" height="85" class="img_3"></a></div>
                                        <div class="left tab_wz">
                                            <p class="tab_nr1"><?php echo ($item["title"]); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td width="115"><div class="tab_price">$<span class="price"><?php echo round($item['mall_price']/100,2);?></span></div></td>               					<td width="115"><div class="tab_price"><?php echo ($item['num']); ?></div></td>
                                <td width="116">
                                    <div class="ko">
                                        <span data="<?php echo ($item["goods_id"]); ?>"  class="jian">—</span>
                                        <input type="text" value="<?php echo ($item["buy_num"]); ?>" data="<?php echo ($item["goods_id"]); ?>" rel="<?php echo round($item['mall_price']/100,2);?>" name="num[<?php echo ($item['goods_id']); ?>]" class="spinner">
                                        <span data="<?php echo ($item["goods_id"]); ?>" class="jia">+</span>
                                    </div>
                                </td>
                                <td><span id="jq_total_<?php echo ($item["goods_id"]); ?>" class="money2">$<?php echo round($item['mall_price'] * $item['buy_num']/100,2);?></span></td>
                                <td><a class="jq_delete" rel="<?php echo ($item["goods_id"]); ?>" href="javascript:void(0);">删除</a></td>
                    ...
                    <div class="order_p1">
                        <div class="order_s3">
                            应付总额：<span class="rmb">$</span><label id="jq_total" class="money"><?php echo round($total_money/100,2);?></label>
                        </div>   
