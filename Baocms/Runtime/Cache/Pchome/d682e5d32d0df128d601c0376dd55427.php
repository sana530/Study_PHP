    ...
    <div class="dcsy_top">
        <div class="dcsy_banner">
            <div class="dcsy_flexslider">
                <ul class="slides">
                    <?php  $cache = cache(array('type'=>'File','expire'=> 21600)); $token = md5("Ad, closed=0 AND site_id=14 AND  city_id IN ({$city_ids}) and bg_date <= '{$today}' AND end_date >= '{$today}' ,0,3,21600,orderby asc,,"); if(!$items= $cache->get($token)){ $items = D("Ad")->where(" closed=0 AND site_id=14 AND  city_id IN ({$city_ids}) and bg_date <= '{$today}' AND end_date >= '{$today}' ")->order("orderby asc")->limit("0,3")->select(); $cache->set($token,$items); } ; $index=0; foreach($items as $item): $index++; ?><li class="sy_hotgzLi"><a target="_blank" href="<?php echo ($item["link_url"]); ?>"><img src="<?php echo config_img($item['photo']);?>" width="1200" height="252" /></a></li> <?php endforeach; ?>
                </ul>
            </div>
        </div>
                ...
                <li class="dcsy_sxLi dcsy_sxLixl"><a class="dcsy_sxLiA" href="javascript:void(0);">起送价筛选<em></em></a>
                    <div class="nearbuy_sxkLi2Xl">
                        <ul>
                            ...
                            <li><a href="<?php echo LinkTo('ele/index',$linkArr,array('price'=>2));?>">50-100NZD</a></li>
                            <li><a href="<?php echo LinkTo('ele/index',$linkArr,array('price'=>3));?>">100-200NZD</a></li>
    ...
    <div class="dcsy_spList">
        <ul>
            <?php if(is_array($list)): foreach($list as $key=>$item): ?><li class="dcsy_spLi">
                    ...
                    <?php if($item[bsti] == 0){ ?>
                    <a title="<?php echo ($item["shop_name"]); ?>" href="javascript:void(0);" target="_blank" class="ele_order_now" shop-id="<?php echo ($item['shop_id']); ?>" is-delivery="<?php echo ($item['is_delivery']); ?>">
                        <div class="dcsy_spImg" style="position: relative;"><img src="<?php echo config_img($shops[$item['shop_id']]['photo']);?>" width="208" height="156" /><span class="intro2"><?php echo ($item["d"]); ?></span></div>
                        ...
                        <p class="dcsy_spPf">
                            <?php if($item["is_delivery"] == 1): if($shops[$item["shop_id"]]["is_pei"] == 1): ?><span class="left">起送:$<?php echo round($item['since_money']/100,2);?>
                                        <span class="dcsy_spPs">配送费:$<?php echo round($item['logistics']/100,2);?></span>
                                    </span>
                                    <span class="right"><em class="em_time"></em><?php echo ($item["distribution"]); ?>分钟送达</span>
                                <?php else: ?>
                                    <span class="right">平台配送</span><?php endif; ?>
                            <?php else: ?>
                                <span class="right"><em class="em_time"></em><?php echo ($item["order_ready"]); ?>分钟取餐</span><?php endif; ?>
                        </p>
                        <hr style=" border:none 0px; border-bottom: 1px solid #e0e0e0; margin-top:6px;" />
                        <p class="dcsy_spBq" style="min-height:17px;">
                            <?php if(($item["is_pay"]) == "1"): ?><span class="dcsy_spBq2">&nbsp;</span><?php endif; if(($item["is_new"]) == "1"): ?><span class="dcsy_spBq3">&nbsp;</span><?php endif; if(($item["is_fan"]) == "1"): ?><span class="dcsy_spBq4">&nbsp;</span><?php endif; if(($item["is_delivery"]) == "1"): ?><span class="dcsy_spBq5">送</span><?php endif; ?>
                        </p>
                    </a>

                    <?php }else{ ?>
                     
                    <a title="<?php echo ($item["shop_name"]); ?>" href="javascript:;"><div class="dcsy_spImg"><img src="<?php echo config_img($shops[$item['shop_id']]['photo']);?>" width="208" height="156" /></div>
                        <p class="dcsy_spT"><?php echo ($item["shop_name"]); ?></p>
                        <p class="dcsy_spPf"><span class="left"><span class="spxq_qgpstarBg"><span class="spxq_qgpstar spxq_qgpstar<?php echo ($shops[$item['shop_id']]['score']); ?>"></span></span><?php echo round($shops[$item['shop_id']]['score']/10,1);?>分</span><span style=" color:#fff" class="right borderradius-2">休息中</span></p>
                        ...
                        <hr style=" border:none 0px; border-bottom: 1px solid #e0e0e0; margin-top:6px;" />
                        <p class="dcsy_spBq" style="min-height:17px;"><?php if(($item["is_pay"]) == "1"): ?><span class="dcsy_spBq2">&nbsp;</span><?php endif; if(($item["is_new"]) == "1"): ?><span class="dcsy_spBq3">&nbsp;</span><?php endif; if(($item["is_fan"]) == "1"): ?><span class="dcsy_spBq4">&nbsp;</span><?php endif; ?></p>
                    </a>
...
<div class="seat_yuyue_mask">
    <div class="cont">
        <div class="top">立即下单<a href="javascript:void(0);" class="close right">x</a></div>
        <div class="title"></div>
        <div class="btn_box">
            <a target="_self" href="" class="btn left" >到店消费</a>
            <input type="button" id="order_btn" class="btn btn2 right" shop-id="" value="送餐上门" />
        </div>
        <div class="shuru"></div>
    </div>
</div>
    ...
    $(document).ready(function() {
        ...
        $(".ele_order_now").click(function(){
            if ($(this).attr('is-delivery') == 1) {
                $(".seat_yuyue_mask .btn_box a").attr('href', '<?php echo ($host); ?>/ele/shop/shop_id/'+$(this).attr('shop-id')+'.html');
                $(".seat_yuyue_mask .btn_box input").attr('shop-href', '<?php echo ($host); ?>/ele/shop/shop_id/'+$(this).attr('shop-id')+'/delivery/1.html');
                $(".seat_yuyue_mask").show();
            } else {
                location.href = '<?php echo ($host); ?>/ele/shop/shop_id/'+$(this).attr('shop-id')+'.html';
            }
        });
        ...
        $("#order_btn").click(function(){
            if ($(this).attr('shop-href') != '') {
                location.href = $(this).attr('shop-href');
            }
        });
