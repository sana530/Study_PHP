...
<div class="tuan_content">
    ...
    <div class="radius5 tuan_top">
      ...
      <div class="tuanfabu_tab">
        <ul>
            <li class="tuanfabu_tabli <?php if(($act) == "index"): ?>on<?php endif; ?>"><a href="<?php echo U('tuan/index');?>">正在抢购</a></li>
            <li class="tuanfabu_tabli <?php if(($act) == "history"): ?>on<?php endif; ?>"><a href="<?php echo U('tuan/history');?>">往期抢购</a></li>
            <li class="tuanfabu_tabli <?php if(($act) == "order"): ?>on<?php endif; ?>"><a href="<?php echo U('tuan/order');?>">订单管理</a></li>
            <li class="tuanfabu_tabli <?php if(($act) == "code"): ?>on<?php endif; ?>"><a href="<?php echo U('tuan/code');?>">抢购券列表</a></li>
            <li class="tuanfabu_tabli <?php if(($act) == "used"): ?>on<?php endif; ?>"><a href="<?php echo U('tuan/used');?>">抢购券验证</a></li>
            <li class="tuanfabu_tabli <?php if(($act) == "usedok"): ?>on<?php endif; ?>"><a href="<?php echo U('tuan/usedok');?>">验证记录</a></li>
        </ul>
    </div>
    <table class="tuan_table" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
            <tr>
                ...
                <td><img src="<?php echo config_img($var['photo']);?>"  style="width: 100px; margin: 0px auto;" /></td>
