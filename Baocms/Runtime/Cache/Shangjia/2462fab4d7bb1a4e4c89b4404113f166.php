...
<?php if($ele['is_voice'] == 1): ?><script language="javascript" type="text/javascript"> 
	var i = <?php echo ($ele['is_refresh_second']); ?>; 
	var intervalid; 
	intervalid = setInterval("fun()", 1000); 
	function fun() { 
		if (i == 0) { 
			window.location.href = "<?php echo U('eleorder/index');?>"; 
...
<div class="Refresh">
    <ul>
        <p>将在 <span id="mes"><?php echo ($ele['is_refresh_second']); ?></span> 秒后为你自动刷新订单！</p> 
    </ul>
</div><?php endif; ?>
...
<div class="tuan_content">
    ...
    <div class="tuanfabu_tab">
        <ul>
            ...
            <?php if($ding['is_pei'] == 0): ?><li class="tuanfabu_tabli tabli_change"><a href="<?php echo U('eleorder/whole');?>">全部订单</a></li>
            <li class="tuanfabu_tabli tabli_change  on"><a href="<?php echo U('eleorder/index');?>">确认订单</a></li>
            ...
            <?php else: ?>
            <li class="tuanfabu_tabli tabli_change"><a href="<?php echo U('ele/index');?>">外卖营业状态</a></li>
            <li class="tuanfabu_tabli tabli_change on"><a href="<?php echo U('eleorder/index');?>">确认订单</a></li>
            <li class="tuanfabu_tabli tabli_change"><a href="<?php echo U('eleorder/wait');?>">配送中的订单</a></li>
            <li class="tuanfabu_tabli tabli_change"><a href="<?php echo U('eleorder/over');?>">已完成订单</a></li><?php endif; ?>
    ...
    <table class="tuan_table" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$var): $is_pei = D('Shop') -> where('shop_id ='.$var['shop_id']) -> getField('is_pei'); $users = D('Users') -> find($var['user_id']); ?>
            <tr>
                ...
                <td>
                    <a mini='confirm' href="<?php echo U('eleorder/queren',array('order_id'=>$var['order_id']));?>">确认</a>  
                </td>
