...
<div class="blank-20"></div>
     <table class="tuan_table3" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr style="background-color:#F9F9F9;">
            ...
            <td>总价</td>
            <td>买家姓名</td>
            <?php if($shops[$shop_id]['is_direct_sale'] == 1): ?><td>收货时间</td><?php endif; ?>
            <td>状态</td>
            <td>实付金额</td>
            <td>评价</td>
     </table>
  ...
  <tr>
    ...
    <?php if(is_array($goods)): foreach($goods as $key=>$good): if(($good["order_id"]) == $order["order_id"]): ?><table  class="tuan_table2" width="100%" border="0">
      <tr class="tr_left_1">
        ...
        <div class="index__infos___A6XLq" >
            ...
            <?php if(!empty($good[key_name])): ?><span style="color:red;">规格:<?php echo ($good[key_name]); ?></span><?php endif; ?>        	
        	</div>
		</div>
       <!--商品展示END-->
   ...
   <td class="left6" width="9%">
    ...
    <td class="left7" width="8%">
      <?php echo ($order['collection_time']); ?>
    </td>
    <td class="left7" width="8%">
    ...
    <td class="left9"width="9%"><?php if(($order["is_dianping"]) == "1"): ?>已点评<?php else: ?>未评<?php endif; ?></td>
  </tr>
