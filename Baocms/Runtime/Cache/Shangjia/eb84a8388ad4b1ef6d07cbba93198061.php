...
<div class="sjgl_lead">
    <ul>
        <li><a href="#">Mall</a> > <a href="">订单</a> > <a>待退款订单</a></li>
    </ul>
</div>
<div class="tuan_content">
    <form method="post" action="<?php echo U('order/wait_refunded');?>">
...
<?php if(is_array($list)): foreach($list as $key=>$order): ?><table  class="tuan_table1"  width="100%" border="0">
  ...
  <tr>
    ...
    <td class="left7" width="8%">
        ...
        <?php if($order['status'] == 4): ?><a class="href"  mini='confirm' href="<?php echo U('order/refund',array('order_id'=>$order['order_id']));?>">确认退款</a><br/><?php endif; ?>
