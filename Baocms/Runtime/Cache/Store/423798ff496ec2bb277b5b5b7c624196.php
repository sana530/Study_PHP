...
<div class="container">
		<div class="line detail-base">
			<div class="x5">
				<div class="pic">
					<img src="<?php echo config_img($SHOP['logo']);?>"><a href="<?php echo U('audit/index');?>"></a>
			...
			<div class="x7">
                ...
                <p>商户资金: &#36; <?php echo round($MEMBER['gold']/100,2);?> NZD&nbsp;</p>
...
<div class="panel-list">
	<ul>
        ...
        <?php if(!empty($SHOPGRADE['is_tuan'])): ?><li>
        ...
        <?php if($counts['shop_booking'] > 0): ?><li><a href="<?php echo U('booking/index');?>"><span class="icon-btc"></span>订座<i class="icon-angle-right"></i></a></li><?php endif; ?>
